namespace R3BinderTools.Design
{
    ...
    public partial class BindButton : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.FillEllipse(new SolidBrush(Color.FromArgb(25, Color.Black)), int_0 - float_0 / 2f, int_1 - float_0 / 2f, float_0, float_0);

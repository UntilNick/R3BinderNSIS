namespace R3BinderTools.Design
{
    ...
    public static class GraphBox
    {
        ...
        public static Color NColor(Color one, Color two, double db) =>
            Color.FromArgb((int)((one.R * (S - (db / V))) + (two.R * (db / V))), (int)((one.G * (S - (db / V))) + (two.G * (db / V))), (int)((one.B * (S - (db / V))) + (two.B * (db / V))));
        public static Color GpColor(Color one, Color two) =>
            Color.FromArgb((int)((one.R * (double)1) + (two.R * 0.0)), (int)((one.G * (double)1) + (two.G * 0.0)), (int)((one.B * (double)1) + (two.B * 0.0)));
        public static GraphicsPath Graph4(Rectangle rectangle_0, float float_0) =>
        Graph1(rectangle_0.X, rectangle_0.Y, rectangle_0.Width, rectangle_0.Height, float_0);
    }
}